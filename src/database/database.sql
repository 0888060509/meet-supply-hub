...
CREATE INDEX idx_request_items_supply_id ON request_items(supply_id);
CREATE INDEX idx_room_equipment_equipment_type_id ON room_equipment(equipment_type_id); 